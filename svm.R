...
parameters = list(
  ...
  "sigma" = list("0_1" = 10^(-7), "0_2" = 10^(-7), "0_3" = 10^(-7),
                 "0_4" = 10^(-7), "0_5" = 10^(-7), "0_6" = 10^(-7),
                 "0_7" = 10^(-7), "0_8" = 10^(-7), "0_9" = 10^(-7),
                 "1_2" = 10^(-7), "1_3" = 10^(-7), "1_4" = 10^(-7),
                 "1_5" = 10^(-7), "1_6" = 10^(-7), "1_7" = 10^(-7),
                 "1_8" = 10^(-7), "1_9" = 10^(-7), "2_3" = 10^(-7),
                 "2_4" = 10^(-7), "2_5" = 10^(-7), "2_6" = 10^(-7),
                 "2_7" = 10^(-7), "2_8" = 10^(-7), "2_9" = 10^(-7),
                 "3_4" = 10^(-7), "3_5" = 10^(-7), "3_6" = 10^(-7),
                 "3_7" = 10^(-7), "3_8" = 10^(-7), "3_9" = 10^(-7),
                 "4_5" = 10^(-7), "4_6" = 10^(-7), "4_7" = 10^(-7),
                 "4_8" = 10^(-7), "4_9" = 10^(-7), "5_6" = 10^(-7),
                 "5_7" = 10^(-7), "5_8" = 10^(-7), "5_9" = 10^(-7),
                 "6_7" = 10^(-7), "6_8" = 10^(-7), "6_9" = 10^(-7),
                 "7_8" = 10^(-7), "7_9" = 10^(-7), "8_9" = 10^(-7)))
